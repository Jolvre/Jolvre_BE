package com.example.jolvre.infra.security;

import com.example.jolvre.infra.security.jwt.JwtAuthenticationProcessingFilter;
import com.example.jolvre.infra.security.jwt.JwtService;
import com.example.jolvre.infra.security.login.CustomJsonUsernamePasswordAuthenticationFilter;
import com.example.jolvre.infra.security.login.LoginFailureHandler;
import com.example.jolvre.infra.security.login.LoginService;
import com.example.jolvre.infra.security.login.LoginSuccessHandler;
import com.example.jolvre.infra.security.oauth.CustomOAuth2UserService;
import com.example.jolvre.infra.security.oauth.OAuth2LoginFailureHandler;
import com.example.jolvre.infra.security.oauth.OAuth2LoginSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> {
                    request.requestMatchers("/", "/css/**", "/images/**", "/js/**", "/favicon.ico", "/h2-console/**")
