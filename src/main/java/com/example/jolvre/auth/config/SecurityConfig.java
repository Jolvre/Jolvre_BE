...
import com.example.jolvre.auth.jwt.login.service.LoginFailureHandler;
import com.example.jolvre.auth.jwt.login.service.LoginService;
import com.example.jolvre.auth.jwt.login.service.LoginSuccessHandler;
        ...
        http
                ...
                .authorizeHttpRequests(request -> {
                    ...
                    request.requestMatchers("/sign-up", "/api/v1/student/verify", "/api/v1/student/verify/**",
                                    "/api/v1/auth/**", "/api/v1/user/check/**", "/api/v1/signUp/**")
