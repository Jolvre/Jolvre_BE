...
import com.example.jolvre.auth.jwt.service.LoginFailureHandler;
import com.example.jolvre.auth.jwt.service.LoginService;
import com.example.jolvre.auth.jwt.service.LoginSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> {
                    ...
                    request.requestMatchers("/api/v1/auth/**").permitAll(); // AuthController
