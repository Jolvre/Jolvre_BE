...
import com.example.jolvre.auth.oauth.entity.OAuthAttributes;
...
//        return new PrincipalDetails(createdUser, attributes);
    ...
    /**
     * OAuthAttributes의 toEntity() 메소드를 통해 빌더로 User 객체 생성 후 반환 생성된 User 객체를 DB에 저장 : socialType, socialId, email, role
     * 값만 있는 상태
     */
